...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/17 01:04:17 by ttran             #+#    #+#             */
/*   Updated: 2018/03/17 01:04:22 by ttran            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lemin.h"

static t_graph	*link_name(t_super *hold, char *room_name)
{
	t_graph		*checker;
...
/*
** You made a mistake here where you forgot to connect vertice->link
** to anything. When it started with NULL, at least.
*/

static void		create_link(t_graph *vertice, t_graph *edge)
{
	t_link		*ptr;
...
static int		validate_link_specs(char **fuck, t_super *hold)
{
	t_graph		*vertice;
	t_graph		*edge;
...
static int		setup_link(t_super *hold, char *line)
{
	char		**fuck;
	int			flag;
